...
SELECT subscription_status,COUNT(customer_id), ROUND(AVG(purchase_amount),2) AS Average_Spend , ROUND(SUM(purchase_amount),2) AS Total_Revenue FROM customer
GROUP BY subscription_status ORDER BY Total_Revenue,Average_Spend;
